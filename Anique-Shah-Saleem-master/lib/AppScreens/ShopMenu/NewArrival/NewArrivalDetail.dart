...
class NewArrivalProductDetail extends StatefulWidget {
  final Map<String, Object> AllProduct;
  const NewArrivalProductDetail({super.key, required this.AllProduct});

  @override
  State<NewArrivalProductDetail> createState() => _NewArrivalProductDetailState();
}

class _NewArrivalProductDetailState extends State<NewArrivalProductDetail> {
  var selectedSize = '';
