...
class AllCollectionProductDetail extends StatefulWidget {
  final Map<String, Object> AllProduct;
  const AllCollectionProductDetail({super.key, required this.AllProduct});

  @override
  State<AllCollectionProductDetail> createState() => _AllCollectionProductDetailState();
}

class _AllCollectionProductDetailState extends State<AllCollectionProductDetail> {
  var selectedSize = '';
  int quantity = 1;
