...
class JacketProductDetail extends StatefulWidget {
  final Map<String, Object> AllProduct;
  const JacketProductDetail({super.key, required this.AllProduct});

  @override
  State<JacketProductDetail> createState() => _JacketProductDetailState();
}

class _JacketProductDetailState extends State<JacketProductDetail> {
  var selectedSize = '';
  int quantity = 1;
